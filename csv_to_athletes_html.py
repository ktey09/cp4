...
def gen_athlete_page(data, outfile, prev_athlete=None, next_athlete=None):
   ...
   <header>
      <!--Athlete would input headshot-->
       <h1>{data["name"]}</h1>
       <a href = "../images/profiles/{data["athlete_id"]}.jpg" data-lightbox="tea" data-alt="Athlete headshot">
   ...
   html_content += '''
                     ...
                     Follow us on Instagram <a href="https://www.instagram.com/a2skylinexc/" aria-label="Follow us on Instagram">
